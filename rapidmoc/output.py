...
# inversed interpolation to find depth corresponding to  sigma_th_flx
    ...
    t_basin = dataset.createVariable('t_basin',np.float64,(tdim.name,pdim.name))
    t_basin.units = 'degC'
    ...
    s_basin = dataset.createVariable('s_basin',np.float64,(tdim.name,pdim.name))
    s_basin.units = 'PSU'
    ...
    sf_rapid = dataset.createVariable('sf_rapid',np.float64,(tdim.name,pdim.name))
    sf_rapid.units = 'Sv'
    ...
    # Meridional overturning transport time series - model v
    sf_model = dataset.createVariable('sf_model',np.float64,(tdim.name,pdim.name))
    sf_model.units = 'Sv'
    ...
    sf_fc = dataset.createVariable('sf_fc',np.float64,(tdim.name,pdim.name))
    sf_fc.units = 'Sv'
    ...
    sf_ek = dataset.createVariable('sf_ek',np.float64,(tdim.name,pdim.name))
    sf_ek.units = 'Sv'
    ...
    # Wbw stream function 
    sf_wbw = dataset.createVariable('sf_wbw',np.float64,(tdim.name,pdim.name))
    sf_wbw.units = 'Sv'
    ...
    sf_geoint = dataset.createVariable('sf_geoint',np.float64,(tdim.name,pdim.name))
    sf_geoint.units = 'Sv'
    ...
    sf_mo = dataset.createVariable('sf_mo',np.float64,(tdim.name,pdim.name))
    sf_mo.units = 'Sv'
